function[v] = cal_ave(month_data, year_num, month_num)
v = zeros(48,1);
...
v = v ./ 31;
elseif((month_num == 2 && year_num == 2008) || (month_num == 2 && year_num == 2012) ) v = v ./ 29;
elseif((month_num == 2 && year_num != 2008) && (month_num == 2 && year_num != 2012) ) v = v ./ 28;
else v = v ./ 30;
endif
